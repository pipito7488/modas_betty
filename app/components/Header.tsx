...
import { ShoppingCart, User, LogIn, LogOut, Menu, X, Package, ShoppingBag } from 'lucide-react';
                ...
                <div className="container mx-auto max-w-7xl px-4">
                    <div className="flex items-center justify-between h-20 transition-all duration-300">
                        ...
                        <div className="flex items-center gap-6">
                            {/* Orders Dropdown - Only for logged in users */}
                            {session && (
                                <div className="relative">
                                    <button
                                        onClick={() => setOrdersOpen(!ordersOpen)}
                                        className="relative text-gray-600 hover:text-amber-700 transition-transform hover:scale-110 duration-300"
                                        ...
                                        <>
                                            ...
                                            <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-20">
                                                ...
                                                >
                                                    ...
                                                    <div>
                                                        <p className="text-sm font-medium text-gray-900">Mis Compras</p>
                                                        <p className="text-xs text-gray-500">Órdenes que realicé</p>
                                                    </div>
                                                </Link>

                                                {(session.user?.role === 'vendedor' || session.user?.role === 'admin') && (
                                                    <>
                                                        ...
                                                        >
                                                            ...
                                                            <div>
                                                                <p className="text-sm font-medium text-gray-900">Mis Ventas</p>
                                                                <p className="text-xs text-gray-500">Órdenes de clientes</p>
                                                            </div>
                                                        </Link>
                                                    </>
                                                )}
                            ...
                            >
                                ...
                                {itemCount > 0 && (
                                    <span className="absolute -top-2 -right-2 bg-amber-700 text-white text-[10px] w-5 h-5 flex items-center justify-center rounded-full font-bold animate-pulse">
